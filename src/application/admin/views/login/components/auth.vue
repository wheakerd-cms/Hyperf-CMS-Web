...
import Copyright from '@/application/admin/layouts/basic/copyright.vue';
...
const preferenceCopyright = {
    companyName: 'Wheakerd',
...
<template>
    <div
        :class="['dark']"
        class="w-100 h-100 flex min-h-full flex-1 select-none overflow-x-hidden"
    >
        ...
        <!-- 系统介绍 -->
        <div v-if="true" class="relative hidden w-0 flex-1 lg:block">
            <div
