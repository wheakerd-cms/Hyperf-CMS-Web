...
} from '@/application/admin/constants';
import {objToFormData,} from '@/application/admin/utils';
...
const defaultResponseInterceptors = (response: AxiosResponse): any => {
    if (response?.config?.responseType === 'blob') {
        ...
        // if (response.headers[useUserStore().getTokenKey]) {
        //     useUserStore().setToken(
        //         response.headers[useUserStore().getTokenKey]
        //     );
        // }
